...
{"add_action",F_ADD_ACTION,0,0,2,3,TYPE_NOVALUE,T_STRING|T_FUNCTION,T_STRING|T_ARRAY,T_NUMBER,T_ANY,78,DEFAULT_NONE},
...
{"allocate",F_ALLOCATE,0,0,1,2,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,152,DEFAULT_NONE},
{"allocate_buffer",F_ALLOCATE_BUFFER,0,0,1,1,TYPE_BUFFER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"allocate_mapping",F_ALLOCATE_MAPPING,0,0,1,2,TYPE_MAPPING,T_NUMBER|T_ARRAY,T_ANY,T_ANY,T_ANY,122,DEFAULT_NONE},
...
{"clear_bit",F_CLEAR_BIT,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,93,DEFAULT_NONE},
...
{"crc32",F_CRC32,0,0,1,1,TYPE_NUMBER,T_STRING|T_BUFFER,T_ANY,T_ANY,T_ANY,104,DEFAULT_NONE},
{"crypt",F_CRYPT,0,0,2,2,TYPE_STRING,T_STRING,T_STRING|T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
{"ctime",F_CTIME,0,0,1,1,TYPE_STRING,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"debug_info",F_DEBUG_INFO,0,0,2,2,TYPE_ANY,T_NUMBER,T_OBJECT,T_ANY,T_ANY,182,DEFAULT_NONE},
...
{"deep_inventory",F_DEEP_INVENTORY,0,0,1,1,TYPE_MOD_ARRAY|TYPE_OBJECT,T_OBJECT,T_ANY,T_ANY,T_ANY,25,DEFAULT_NONE},
...
{"ed",F_ED,0,0,0,4,TYPE_NOVALUE,T_STRING,T_STRING,T_STRING|T_NUMBER,T_NUMBER,207,DEFAULT_NONE},
...
{"exec",F_EXEC,0,0,2,2,TYPE_NUMBER,T_OBJECT,T_OBJECT,T_ANY,T_ANY,184,DEFAULT_NONE},
...
{"external_start",F_EXTERNAL_START,0,0,4,5,TYPE_NUMBER,T_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,234,DEFAULT_NONE},
...
{"filter",F_FILTER,0,0,2,-1,TYPE_ANY,T_ARRAY|T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,216,DEFAULT_NONE},
{"filter_array",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,201,DEFAULT_NONE},
{"filter_mapping",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,217,DEFAULT_NONE},
{"find_call_out",F_FIND_CALL_OUT,0,0,1,1,TYPE_NUMBER,T_NUMBER|T_STRING,T_ANY,T_ANY,T_ANY,119,DEFAULT_NONE},
{"find_living",F_FIND_LIVING,0,0,1,1,TYPE_OBJECT,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"find_object",F_FIND_OBJECT,0,0,2,2,TYPE_OBJECT,T_STRING,T_NUMBER,T_ANY,T_ANY,93,0},
...
{"function_exists",F_FUNCTION_EXISTS,0,0,1,3,TYPE_STRING,T_STRING,T_OBJECT,T_NUMBER,T_ANY,188,DEFAULT_NONE},
...
{"functions",F_FUNCTIONS,0,0,2,2,TYPE_MOD_ARRAY|TYPE_STRING,T_OBJECT,T_NUMBER,T_ANY,T_ANY,190,0},
...
{"get_dir",F_GET_DIR,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_NUMBER,T_ANY,T_ANY,93,0},
{"geteuid",F_GETEUID,0,0,1,1,TYPE_STRING,T_FUNCTION|T_OBJECT,T_ANY,T_ANY,T_ANY,231,DEFAULT_THIS_OBJECT},
...
{"inherits",F_INHERITS,0,0,2,2,TYPE_NUMBER,T_STRING,T_OBJECT,T_ANY,T_ANY,74,DEFAULT_NONE},
...
{"keys",F_KEYS,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,127,DEFAULT_NONE},
{"link",F_LINK,0,0,2,2,TYPE_NUMBER,T_STRING,T_STRING,T_ANY,T_ANY,27,DEFAULT_NONE},
{"living",F_LIVING,0,0,1,1,TYPE_NUMBER,T_OBJECT,T_ANY,T_ANY,T_ANY,25,DEFAULT_NONE},
{"livings",F_LIVINGS,0,0,0,0,TYPE_MOD_ARRAY|TYPE_OBJECT,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"load_object",F_FIND_OBJECT | F_ALIAS_FLAG,0,0,2,2,TYPE_OBJECT,T_STRING,T_NUMBER,T_ANY,T_ANY,93,1},
...
{"map",F_MAP,0,0,2,-1,TYPE_ANY,T_STRING|T_MAPPING|T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,223,DEFAULT_NONE},
{"map_array",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MOD_ARRAY|TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,201,DEFAULT_NONE},
{"map_delete",F_MAP_DELETE,0,0,2,2,TYPE_NOVALUE,T_MAPPING,T_ANY,T_ANY,T_ANY,129,DEFAULT_NONE},
{"map_mapping",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,217,DEFAULT_NONE},
...
{"match_path",F_MATCH_PATH,0,0,2,2,TYPE_ANY,T_MAPPING,T_STRING,T_ANY,T_ANY,133,DEFAULT_NONE},
...
{"message",F_MESSAGE,0,0,3,4,TYPE_NOVALUE,T_ANY,T_ANY,T_STRING|T_ARRAY|T_OBJECT|T_ARRAY,T_OBJECT|T_ARRAY,107,DEFAULT_NONE},
...
{"next_bit",F_NEXT_BIT,0,0,2,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,93,DEFAULT_NONE},
...
{"oldcrypt",F_OLDCRYPT,0,0,2,2,TYPE_STRING,T_STRING,T_STRING|T_NUMBER,T_ANY,T_ANY,97,DEFAULT_NONE},
...
{"pow",F_POW,0,0,2,2,TYPE_REAL,T_REAL,T_REAL,T_ANY,T_ANY,301,DEFAULT_NONE},
{"present",F_PRESENT,0,0,1,2,TYPE_OBJECT,T_OBJECT|T_STRING,T_OBJECT,T_ANY,T_ANY,73,DEFAULT_NONE},
...
{"program_info",F_PROGRAM_INFO,0,0,0,1,TYPE_STRING,T_OBJECT,T_ANY,T_ANY,T_ANY,25,DEFAULT_NONE},
...
{"read_buffer",F_READ_BUFFER,0,0,1,3,TYPE_ANY,T_STRING|T_BUFFER,T_NUMBER,T_NUMBER,T_ANY,156,DEFAULT_NONE},
{"read_bytes",F_READ_BYTES,0,0,1,3,TYPE_STRING,T_STRING,T_NUMBER,T_NUMBER,T_ANY,178,DEFAULT_NONE},
{"read_file",F_READ_FILE,0,0,1,3,TYPE_STRING,T_STRING,T_NUMBER,T_NUMBER,T_ANY,178,DEFAULT_NONE},
{"real_time",F_REAL_TIME,0,0,0,0,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"receive",F_RECEIVE,0,0,1,1,TYPE_NOVALUE,T_STRING|T_BUFFER,T_ANY,T_ANY,T_ANY,104,DEFAULT_NONE},
...
{"reg_assoc",F_REG_ASSOC,0,0,3,4,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_ARRAY,T_ARRAY,T_ANY,144,DEFAULT_NONE},
{"regexp",F_REGEXP,0,0,2,3,TYPE_ANY,T_STRING|T_ARRAY,T_STRING,T_NUMBER,T_ANY,137,DEFAULT_NONE},
...
{"remove_call_out",F_REMOVE_CALL_OUT,0,0,0,1,TYPE_NUMBER,T_NUMBER|T_STRING,T_ANY,T_ANY,T_ANY,119,DEFAULT_NONE},
...
{"repeat_string",F_REPEAT_STRING,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,93,DEFAULT_NONE},
{"replace_program",F_REPLACE_PROGRAM,0,0,1,1,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"replace_string",F_REPLACE_STRING,0,0,3,-1,TYPE_STRING,T_STRING,T_STRING,T_STRING,T_ANY,86,DEFAULT_NONE},
{"replaceable",F_REPLACEABLE,0,0,1,2,TYPE_NUMBER,T_OBJECT,T_ARRAY,T_ANY,T_ANY,255,DEFAULT_NONE},
{"reset_eval_cost",F_SET_EVAL_LIMIT | F_ALIAS_FLAG,0,0,1,1,TYPE_NUMBER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,0},
{"resolve",F_RESOLVE,0,0,2,2,TYPE_NUMBER,T_STRING,T_STRING,T_ANY,T_ANY,27,DEFAULT_NONE},
{"restore_object",F_RESTORE_OBJECT,0,0,1,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,93,DEFAULT_NONE},
...
{"save_object",F_SAVE_OBJECT,0,0,1,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,93,DEFAULT_NONE},
...
{"set_bit",F_SET_BIT,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,93,DEFAULT_NONE},
...
{"set_reset",F_SET_RESET,0,0,1,2,TYPE_NOVALUE,T_OBJECT,T_NUMBER,T_ANY,T_ANY,190,DEFAULT_NONE},
{"seteuid",F_SETEUID,0,0,1,1,TYPE_NUMBER,T_STRING|T_NUMBER,T_ANY,T_ANY,T_ANY,99,DEFAULT_NONE},
{"shadow",F_SHADOW,0,0,2,2,TYPE_OBJECT,T_OBJECT,T_NUMBER,T_ANY,T_ANY,190,1},
...
{"snoop",F_SNOOP,0,0,1,2,TYPE_OBJECT,T_OBJECT,T_OBJECT,T_ANY,T_ANY,184,DEFAULT_NONE},
{"socket_accept",F_SOCKET_ACCEPT,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,263,DEFAULT_NONE},
{"socket_acquire",F_SOCKET_ACQUIRE,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,284,DEFAULT_NONE},
{"socket_address",F_SOCKET_ADDRESS,0,0,1,1,TYPE_STRING,T_NUMBER|T_OBJECT,T_ANY,T_ANY,T_ANY,295,DEFAULT_NONE},
{"socket_bind",F_SOCKET_BIND,0,0,2,2,TYPE_NUMBER,T_NUMBER,T_NUMBER,T_ANY,T_ANY,100,DEFAULT_NONE},
{"socket_close",F_SOCKET_CLOSE,0,0,1,1,TYPE_NUMBER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"socket_connect",F_SOCKET_CONNECT,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,234,DEFAULT_NONE},
{"socket_create",F_SOCKET_CREATE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,263,DEFAULT_NONE},
...
{"socket_release",F_SOCKET_RELEASE,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_OBJECT,T_STRING|T_FUNCTION,T_ANY,277,DEFAULT_NONE},
{"socket_status",F_SOCKET_STATUS,0,0,0,1,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"socket_write",F_SOCKET_WRITE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_ANY,T_STRING,T_ANY,271,DEFAULT_NONE},
{"sort_array",F_SORT_ARRAY,0,0,2,-1,TYPE_MOD_ARRAY|TYPE_ANY,T_ARRAY,T_NUMBER|T_STRING|T_FUNCTION,T_ANY,T_ANY,194,DEFAULT_NONE},
...
{"stat",F_STAT,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_NUMBER,T_ANY,T_ANY,93,0},
{"store_variable",F_STORE_VARIABLE,0,0,2,2,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,259,DEFAULT_NONE},
...
{"strsrch",F_STRSRCH,0,0,3,3,TYPE_NUMBER,T_STRING,T_STRING|T_NUMBER,T_NUMBER,T_ANY,97,0},
...
{"tell_room",F_TELL_ROOM,0,0,2,3,TYPE_NOVALUE,T_OBJECT|T_STRING,T_STRING|T_OBJECT|T_NUMBER|T_REAL,T_ARRAY,T_ANY,63,DEFAULT_NONE},
{"terminal_colour",F_TERMINAL_COLOUR,0,0,2,4,TYPE_STRING,T_STRING,T_MAPPING,T_NUMBER,T_NUMBER,247,DEFAULT_NONE},
{"test_bit",F_TEST_BIT,0,0,2,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,93,DEFAULT_NONE},
...
{"unique_mapping",F_UNIQUE_MAPPING,0,0,2,-1,TYPE_MAPPING,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,201,DEFAULT_NONE},
...
{"values",F_VALUES,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,127,DEFAULT_NONE},
{"variables",F_VARIABLES,0,0,2,2,TYPE_MOD_ARRAY|TYPE_STRING,T_OBJECT,T_NUMBER,T_ANY,T_ANY,190,0},
...
{"write_buffer",F_WRITE_BUFFER,0,0,3,3,TYPE_NUMBER,T_STRING|T_BUFFER,T_NUMBER,T_STRING|T_BUFFER|T_NUMBER,T_ANY,163,DEFAULT_NONE},
{"write_bytes",F_WRITE_BYTES,0,0,3,3,TYPE_NUMBER,T_STRING,T_NUMBER,T_STRING,T_ANY,93,DEFAULT_NONE},
{"write_file",F_WRITE_FILE,0,0,2,3,TYPE_NUMBER,T_STRING,T_STRING,T_NUMBER,T_ANY,172,DEFAULT_NONE},
